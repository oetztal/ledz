...
void test_color_extraction() {
    ...
    TEST_ASSERT_EQUAL_UINT8(0x12, Support::Color::red(test_color));
    TEST_ASSERT_EQUAL_UINT8(0x34, Support::Color::green(test_color));
    TEST_ASSERT_EQUAL_UINT8(0x56, Support::Color::blue(test_color));
}

void test_color_construction() {
    Strip::Color result = Support::Color::from_rgb(0x12, 0x34, 0x56);
    TEST_ASSERT_EQUAL_UINT32(0x123456, result);
}

void test_color_red_component() {
    Strip::Color pure_red = 0xFF0000;
    TEST_ASSERT_EQUAL_UINT8(0xFF, Support::Color::red(pure_red));
    TEST_ASSERT_EQUAL_UINT8(0x00, Support::Color::green(pure_red));
    TEST_ASSERT_EQUAL_UINT8(0x00, Support::Color::blue(pure_red));
}

void test_color_green_component() {
    Strip::Color pure_green = 0x00FF00;
    TEST_ASSERT_EQUAL_UINT8(0x00, Support::Color::red(pure_green));
    TEST_ASSERT_EQUAL_UINT8(0xFF, Support::Color::green(pure_green));
    TEST_ASSERT_EQUAL_UINT8(0x00, Support::Color::blue(pure_green));
}

void test_color_blue_component() {
    Strip::Color pure_blue = 0x0000FF;
    TEST_ASSERT_EQUAL_UINT8(0x00, Support::Color::red(pure_blue));
    TEST_ASSERT_EQUAL_UINT8(0x00, Support::Color::green(pure_blue));
    TEST_ASSERT_EQUAL_UINT8(0xFF, Support::Color::blue(pure_blue));
}
...
void test_wheel_byte_identical_at_integer_inputs() {
    for (int h = 0; h <= 254; h++) {
        ...
        Strip::Color actual = Support::Color::wheel(static_cast<float>(h));
        TEST_ASSERT_EQUAL_UINT32_MESSAGE(expected, actual, ("hue=" + std::to_string(h)).c_str());
    }
}

void test_wheel_pure_red_green_blue() {
    TEST_ASSERT_EQUAL_UINT32(0xFF0000, Support::Color::wheel(0.0f));
    TEST_ASSERT_EQUAL_UINT32(0x00FF00, Support::Color::wheel(85.0f));
    TEST_ASSERT_EQUAL_UINT32(0x0000FF, Support::Color::wheel(170.0f));
}
...
void test_wheel_pure_yellow_cyan_magenta() {
    ...
    TEST_ASSERT_EQUAL_UINT32(0xFFFF00, Support::Color::wheel(42.5f));
    TEST_ASSERT_EQUAL_UINT32(0x00FFFF, Support::Color::wheel(127.5f));
    TEST_ASSERT_EQUAL_UINT32(0xFF00FF, Support::Color::wheel(212.5f));
}

void test_wheel_wraps_at_full_revolutions() {
    TEST_ASSERT_EQUAL_UINT32(Support::Color::wheel(0.0f), Support::Color::wheel(255.0f));
    TEST_ASSERT_EQUAL_UINT32(Support::Color::wheel(0.0f), Support::Color::wheel(510.0f));
}

void test_wheel_wraps_negative_inputs() {
    TEST_ASSERT_EQUAL_UINT32(Support::Color::wheel(254.0f), Support::Color::wheel(-1.0f));
    TEST_ASSERT_EQUAL_UINT32(Support::Color::wheel(0.0f), Support::Color::wheel(-255.0f));
}
...
void test_wheel_clamps_sub_degree_hue() {
    ...
    TEST_ASSERT_EQUAL_UINT32(Support::Color::wheel(254.0f), Support::Color::wheel(254.7f));
}

void test_wheel_nan_returns_black() {
    TEST_ASSERT_EQUAL_UINT32(0x000000, Support::Color::wheel(std::numeric_limits<float>::quiet_NaN()));
}

void test_wheel_infinities_return_black() {
    TEST_ASSERT_EQUAL_UINT32(0x000000, Support::Color::wheel(std::numeric_limits<float>::infinity()));
    TEST_ASSERT_EQUAL_UINT32(0x000000, Support::Color::wheel(-std::numeric_limits<float>::infinity()));
}
